...
peri = list(range(-1,202))
for x in peri:
    editor.placeBlock((-1, 65, x), Block("dark_oak_fence"))
    editor.placeBlock((201, 65, x), Block("dark_oak_fence"))
    editor.placeBlock((x, 65, -1), Block("dark_oak_fence"))
    editor.placeBlock((x, 65, 201), Block("dark_oak_fence"))

y_dirt = list(range(59,64))
y_stone = list(range(0,59))
...
z_rand = np.random.randint(0, 200 + 1, size=18).tolist()
y_rand = np.random.randint(20, 53 + 1, size=18).tolist()
